...
public class Companhia {
    ...
    public ArrayList<Trajeto> verificaTodosCaminhos(Aeroporto source, Aeroporto destination, int limite) {
    ...
    public String listarTrajetos(Aeroporto origem, Aeroporto destino, int limite) {
        ...
        listaTrajetos = verificaTodosCaminhos(origem, destino, limite);
